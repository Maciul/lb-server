...
**GET one note:**
curl -i -H "Content-Type: application/json" -X GET http://localhost:3000/api/notes/<insertIDnumber> (ex.1)

**Search notes by Keyword:**
curl -i -H "Content-Type: application/json" -X GET http://localhost:3000/api/notes?query=<keyword> (ex. TPS)
